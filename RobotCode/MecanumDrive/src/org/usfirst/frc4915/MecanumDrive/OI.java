...
public class OI {
	...
	public OI() {
		 ...
		 * DRIVE STRAIGHT
		 */
		SmartDashboard.putData("Move Straight 9 feet", new MoveStraightPositionModeCommand(9,0.7));
		SmartDashboard.putData("Move Backwards 9 feet", new MoveStraightPositionModeCommand(-9,0.7));
