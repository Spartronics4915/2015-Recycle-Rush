...
public class RobotMap {
    ...
    public static DoubleSolenoid babySolenoid;
	...
	// Double Solenoid instantiation. Wiring: 0 --> Forward channel (extended). 1 --> Reverse channel (retracted).
	 mommaSolenoid = new DoubleSolenoid(0, 0, 1);      
     LiveWindow.addActuator("Grabber", "Momma Solenoid",mommaSolenoid);
     
     babySolenoid = new DoubleSolenoid(0, 2, 3);      
     LiveWindow.addActuator("Grabber", "Baby Solenoid", babySolenoid);
