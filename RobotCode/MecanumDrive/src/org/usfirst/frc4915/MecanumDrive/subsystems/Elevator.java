...
public class Elevator extends Subsystem {
    ...
    public void moveToPosition(double position) {
        ...
        if (roundPosition(position) == roundPosition(getPosition())) {
            ...
            /*
             * TODO double distanceToTravel = roundPosition(getPosition()) -
             * roundPosition(position); math to convert distanceToTravel to rotations or time to
             * travel
             */
    ...
    private double roundPosition(double position) {
        System.out.printf("position has been rounded from %f to %f", position,
                Double.parseDouble(new DecimalFormat("#.#").format(position)));
